export default function Footer() {
  const links = {
    Journey: [
      ...
      { label: 'Custom Builder', id: 'custom' },
      { label: 'Our Fleet', id: 'fleet' },
      { label: 'About Us', id: 'about' },
    ],

    Destinations: [
      { label: 'Coonoor', href: '/explore/coonoor' },
      { label: 'Ooty', href: '/explore/ooty' },
      { label: 'Kotagiri', href: '/explore/kotagiri' },
      { label: 'Masinagudi', href: '/explore/masinagudi' },
    ],
  }
  ...
  return (
    <footer style={{ backgroundColor: 'var(--navy)' }}>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr] gap-20">
          {/* Brand */}
          <div className="md:col-span-1">
            <img
              src="/logos/bluemist-dark-nav.png"
            ...
            >
              Slow journeys through the Nilgiris. Private experiences shaped by
              locals who call these hills home.
            </p>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            © 2026 BlueMist Journeys. Built in the Nilgiris.
          </p>
          <p
            style={{
              fontFamily: "'DM Sans', sans-serif",
